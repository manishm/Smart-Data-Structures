...
public:
        ...
        boolean enq(_T* const inValue, CasInfo& in_cas_info) {
        ...
        _T* deq(CasInfo& in_cas_info) {
                ...
                _T* const curr_value = new_head->_value;        // Queue not empty.  Read value before release
